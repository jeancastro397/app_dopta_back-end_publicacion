...
urlpatterns = [
    ...
    path('agregar/mascota/<int:pk>', AddFavoritoMascota.as_view(), name='add-mascota-favorito'),
    ...
    path('agregar/evento/<int:pk>', AddFavoritoEvento.as_view(), name='add-evento-favorito'),
    ...
    path('agregar/servicio/<int:pk>', AddFavoritoServicio.as_view(), name='add-servicio-favorito'),
